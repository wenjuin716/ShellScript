...
show_usage() {
    ...
    echo -e "  This script executes Step 3: SDK Compilation specifically for prpl410 (prplos-prplware-v4.1.0)."
...
# Define the specific SDK version for prpl410
export SDK_VER_NAME="prplos-prplware-v4.2.0"
